...
# Clahan Academy V2 - PRODUCTION Environment
# Higher availability, bigger resources, geo-redundant
...
module "keyvault" {
  ...
  secrets = {
    ...
    judge0_db_connection_string = "PLACEHOLDER"
