...
# Resource Inventory & Cost Reporter function app
...
# Allow Function App to query cost management in the Resource Group
...
# Allow Function App to read resource lists in the Resource Group
